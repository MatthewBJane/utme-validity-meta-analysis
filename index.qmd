...
names(reliability_table) <- c('Discipline', '$N$','Mean Inter-Year GPA Correlation ($\\bar{r}_{y_iy_j}$)')

kable(reliability_table,align = 'lcc',digits = 3, booktabs = TRUE)
```
...
Whether students took the computer-based UTME rather than the pen-and-paper version (pre-2014).
